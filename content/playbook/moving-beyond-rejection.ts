...
// Authored content (Phase 5/5B), written at ~5th-grade reading level: short sentences,
// plain words. FIRST BUILD = the two screen-complete Plays only (read-and-decide,
// what-it-actually-means). The other four Plays are NOT authored here until they
// complete their own Phase-5/5B design + approval (R6).
...
export const MOVING_BEYOND_REJECTION: PlaybookContent = {
  ...
  recognitionCards: [
    ...
    },
    {
      id: "rec-selection",
      role: "route",
      pathwayPlayId: "is-this-right-for-you",
    ...
    },
    {
      id: "rec-over-invest",
      role: "route",
      pathwayPlayId: "how-much-to-put-in",
    ...
    },
    {
      id: "rec-self-edit",
      role: "route",
      pathwayPlayId: "say-the-real-thing",
    ...
    },
    {
      id: "rec-fatigue",
      role: "route",
      pathwayPlayId: "rest-or-giving-up",
