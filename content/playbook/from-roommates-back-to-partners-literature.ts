  ...
  SAFETY_GUIDE, // shared — do not re-author per cluster
  {
    ...
    body: [
      ...
      },
      {
        ...
        body: [
          "We feel like roommates. We work well together but we don't feel close. We only talk about responsibilities.",
      ...
      },
      {
        ...
        body: [
          ...
          "It matters because it tells you what would actually help. Not more time together. Not fixing the day-to-day stuff. Being known by them again, in a way you currently aren't.",
        ],
      },
      {
        kind: "guardrail",
        body: [
          "This won't tell you the closeness comes back. Sometimes it does and sometimes it doesn't. What it can do is help you name what's missing clearly enough to ask for it. That's more than most people in this spot manage.",
        ],
      },
    ],
  },
    ...
    body: [
      {
        kind: "paragraph",
        body: [
          "When people describe this, they tend to give a list rather than a sentence.",
        ],
      },
      {
        kind: "list",
      ...
      },
      {
        ...
        body: [
          ...
          "And that's exactly what makes it hard to bring up. \u201cI don't feel appreciated\u201d sounds like a complaint about the washing-up. What you mean is much bigger, and much harder to say.",
        ],
      },
      {
        kind: "guardrail",
        body: [
          "The circling isn't you being vague. It's a fair response to something that really doesn't have a good word. But it's worth finding the closest one. A person can respond to a specific thing. They can't respond to a fog.",
        ],
      },
    ],
  },
    ...
    body: [
      {
        ...
        body: [
          ...
          "Nobody decided this. It happens because the day-to-day tasks are urgent and feeling close isn't.",
        ],
      },
      {
        kind: "paragraph",
        body: [
          "The bins have a deadline. The school run has a deadline. Asking each other a real question has no deadline at all, so it goes to the bottom of the list, every day, for good reason.",
      ...
      },
      {
        ...
        body: [
          "You may already spend a lot of time together. Most people in this spot do.",
          "The missing thing isn't hours. It's the kind of talk that isn't about arrangements — and that can happen in four minutes, or not at all in a whole weekend away.",
        ],
      },
    ],
  },
    ...
    body: [
      {
        ...
        body: [
          ...
          "This is grief, and it's worth calling it that. You're not just being sentimental about the past or unrealistic — something real existed, and it isn't there now.",
        ],
      },
      {
        kind: "distinction",
        ...
        body: [
          "Missing the early days. That one isn't coming back, and chasing it will make you miserable — it ran on newness, and newness wears off.",
          "Missing being known and enjoyed by them. That one isn't about the early days at all. You can have it at any stage, and it's what you're actually missing.",
        ],
      },
      {
        kind: "paragraph",
        body: [
          "People often think they want the first and actually want the second. Worth checking which, because they send you in completely different directions.",
        ],
      },
    ],
  },
    ...
    body: [
      ...
      },
      {
        ...
        body: [
          ...
          "They're useful because they're the only place you say what you want, rather than what's missing. A person can do something with a want. Nobody can do anything with a gap.",
        ],
      },
      {
        kind: "distinction",
        ...
        body: [
          "\u201cI don't feel like a priority\u201d invites them to defend themselves. It's a verdict \u2014 there's an argument they can make back.",
...

  {
    ...
    body: [
      ...
      },
      {
        kind: "paragraph",
        body: [
          "It also gets around the biggest obstacle here: neither of you wants to make a Thing of it. A Thing needs both people to show up ready. A small thing needs nothing from them at all.",
        ],
      },
      {
        kind: "guardrail",
    ...
    body: [
      {
        kind: "paragraph",
        body: [
          "Almost everything here gets said as “we.” We're growing apart. We stopped dating each other. We don't laugh like we used to.",
          "That's accurate — it takes two to drift. And that leaves an honest problem: there's one of you reading this.",
        ],
      },
      {
        kind: "distinction",
        ...
        body: [
          "Yours: naming what's missing clearly, saying what you want instead of what's wrong, putting small things back, noticing whether you've stopped reaching.",
...

  {
    ...
    body: [
      ...
      },
      {
        kind: "paragraph",
        body: [
          "Almost nothing you were shown about long relationships covers this part: two capable people quietly stop knowing each other while still running a household well. There's no story about that. It isn't in the films, and people don't mention it at dinner.",
      ...
      },
      {
        kind: "guardrail",
        body: [
          "Knowing it's common doesn't fix it, and isn't meant to. It's meant to stop you spending energy on the extra question of whether something is wrong with you in particular.",
        ],
      },
    ],
  },
    ...
    body: [
      {
        kind: "paragraph",
        body: [
          "Partly. Some of what you're missing was newness, and newness doesn't survive knowing someone for fifteen years. That part is normal, and it isn't coming back.",
        ],
      },
      {
        kind: "distinction",
        ...
        body: [
          "Excitement fading is ordinary. Being unknown by the person you live with isn't the same thing, and it isn't bound to happen.",
          "Plenty of long relationships are pretty ordinary and still have two people who know each other. That's the thing that's missing, and it doesn't depend on how long you've been together.",
        ],
      },
      {
        kind: "guardrail",
    ...
    body: [
      {
        kind: "paragraph",
        body: [
          "Common, and worth checking before you decide it's true.",
          "People notice at different times and say so at different times. Someone can know full well that something has gone, and have no idea how to bring it up — which looks exactly, from the outside, like not caring.",
        ],
      },
      {
        kind: "paragraph",
        body: [
          "The way to find out isn't to piece it together from evidence. It's to say the thing and see. That's uncomfortable, and it's the only way there is.",
        ],
      },
      {
        kind: "guardrail",
...

  {
    ...
    body: [
      ...
      },
      {
        ...
        body: [
          "The fact that this bothers you means something is still there. Real indifference doesn't ache.",
          "That isn't a promise it can be brought back. It does mean you're not as far along as the flatness makes it feel.",
        ],
      },
      {
        kind: "paragraph",
      ...
      },
      {
        kind: "guardrail",
        body: [
          "If the honest answer is that you're asking whether to stay, rather than how to reconnect — that's a fair question, and it's a different one. Worth having with someone, rather than alone.",
        ],
      },
    ],
  },
