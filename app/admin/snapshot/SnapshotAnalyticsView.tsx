...
// Pure presentational view (no data fetching) — rendered by the page once loaded,
// and directly renderable for verification with any payload.
export function SnapshotAnalyticsView({ data: a }: { data: SnapshotAnalytics }) {
  return (
    <div>
