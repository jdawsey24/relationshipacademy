# Cluster 1 — Rev 3 End-to-End Consumer Experience (UX/Content Gate)

**Status:** FOR UX/CONTENT REVIEW. Flag-gated (`PLAYBOOK_REV3_ENABLED`); v0 unchanged when off. No deploy, no migration.
**Scope:** the two currently authored Plays only. The remaining four Cluster-1 Plays are NOT authored.

This renders the **actual** Rev 3 journey the user experiences, in order:
...
- **Adaptive response stays contextual, not a rigid rule.** The evidence-appropriate reconsider response is authored per scenario: in RD both *revising* and *holding "not enough yet"* are Technique Fidelity; in WM *naming the fact while the feeling persists* is fidelity but *holding the global verdict* is not. Nothing hardcodes "always revise."

---

# PLAY A · Read It, Then Decide

## 1 · Entry
**Board card**
> I can't always tell what their behavior means — or when to keep going, ask, slow down, or walk away.
> *You'll learn to:* Tell what you've seen from what you're guessing, and set a clear next move.
> **[ Start ]**

**Gate**
> “I can't always tell what their behavior actually means — or when to keep going, ask, slow down, or walk away.”
> Does this happen for you?
> **[ Yes, this happens ]** · [ Not really me ] · [ I handle this okay ]

“Yes, this happens” → the **simulation** (not the worksheet).

## 2 · Experience — `evidenceTimeline`
*Left-rail “What you've seen so far” accumulates each beat. Header: “Reading the signals over time.”*

- **Moment:** “Great first date. It was easy, and they said they'd love to see you again.” → Continue
- **Moment:** “Over the next four days, their texts get shorter.” → Continue
- **Capture (interpretation)** · *Related read → “When a small change becomes a big story”*
  “What do you think the shorter texts mean?” → They're losing interest · They're just busy this week · That's just how they text · I'm not sure yet
- **Decision (temptation):** “What are you tempted to do right now?”
  - Pull back / Double-text to check / End it now → *teaching beat:* “That's a move made before you have enough to go on. Right now the shorter texts could mean a lot of things. Acting on the story before the evidence is in is the exact habit this is here to interrupt.”
  - Wait and watch a bit → *teaching beat:* “Good instinct — with one catch. Watching only works when you know what you're watching for. Gathering more information isn't the same as waiting forever. Decide what would actually tell you, so ‘wait’ doesn't quietly become ‘never decide.’”
  - *(both rejoin the same reveal)*
- **Reveal** (“New evidence”): “Day 5: they message you to set up a real plan for next week.” → Continue
- **Reconsider:** “Weigh your first read against the new evidence. Where does it land now?”
  - **A** “The plan changes what I can reasonably conclude. I was ahead of the evidence.” → *demonstrated / demonstrated*
  - **B** “Losing interest is still possible, but I don't have enough to call it that yet.” → *demonstrated / demonstrated*
  - **C** “The shorter texts tell me they're losing interest. The plan doesn't really change that.” → *demonstrated / not_demonstrated* → teaching branch: “Both things are real evidence: the shorter texts, and the concrete plan… hold a conclusion the size of everything you've actually seen.”
...
# PLAY B · What It Actually Means

## 1 · Entry
**Board card**
> When something doesn't work out, I start wondering what's wrong with me.
> *You'll learn to:* Separate what happened from what it says about you.
> **[ Start ]**
...
> Does this happen for you? **[ Yes, this happens ]** · [ Not really me ] · [ I handle this okay ]

## 2 · Experience — `conclusionNarrowing`
*Event pinned under “What happened.” Header: “How big did the story get?”*

- **Moment (event):** “After a few good dates, they say: ‘I had a great time, but I don't think we're a match.’” → Continue
- **Decision (first read / expansion)** · *Related read → “When one thing becomes everything”*
  “In the moment, what did that start to turn into?”
  - This will happen with everyone / It'll always be like this / Something's wrong with me / I'm not worth choosing → red “…grew into” chip → `establish-check`
  - **“It hurt, but I didn't make it mean something bigger about me”** → neutral “…and you kept it bounded” chip → *acknowledgment branch:* “That's the move — the sting is real, and you kept it from turning into a verdict about you. Nothing to undo here…”
- **Decision (establish-check)** *(globalizing reads only):* “Which of these does the event actually establish?”
  - “Only that this one person didn't want to continue” → *“Right-sized. That's what the event supports — and it's worth being just as clear about what it doesn't.”*
  - “That something's wrong with me” / “That it'll always be like this” → teaching note: “One event can't establish a claim about everyone, about forever, or about your worth…”
- **Reveal** (“What this actually establishes”):
...
- **Reconsider (narrowing):** “Land it on the smallest true thing the event supports.”
  - **A** “This one person didn't want to keep dating me. That's what the event shows.” → *demonstrated / demonstrated*
  - **B** “I know that's what the event shows, even though the bigger story still feels true right now.” → *demonstrated / demonstrated* — “…the feeling doesn't have to disappear for you to stop treating it as evidence.”
  - **C** “I still think this proves something is wrong with me.” → *demonstrated / not_demonstrated* → branch: “Keep the pain; drop the verdict — the evidence doesn't back it.”
...
## Continuity review (simulation → Play)

- **RD:** the simulation *is* the “shorter texts → concrete plan” scenario; the Play's first scenario-sort is the same situation, now sorted explicitly (saw it / guessing / don't know) and turned into an if-then move. The reader re-meets a scene they just felt, then does the operation on it — continuous, not repetitive.
- **WM:** the simulation *is* the “not a match → bounded conclusion” scenario; the Play then drills the same establish/doesn't-establish operation across three sorts (including a real-pattern case) and the narrowest-true-thing build. Same continuity.
- The handoff line in each simulation explicitly names the operation the Play trains (“exactly what this tool trains” / “Keeping the story the size of the facts is the whole operation”).

## One thing to weigh (readability)
RD Play screens average **14.4 words/sentence** (grade 5.0 overall, but a few long sentences in the shift/real-world copy). If you want the Play prose tightened toward the shorter cadence of the simulation copy, that's a light content pass — flag it and I'll do it as part of this gate rather than later.
