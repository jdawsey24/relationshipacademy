...
export const LETTING_GO_OF_THE_ARMOR: PlaybookContent = {
  ...
  opening: {
    ...
    body: [
      ...
      "Nothing here will ask you to lower your guard. That would be asking you to be more available to the thing that hurt you — and the guard works, which is why you built it.",
      "What's worth looking at is what it costs, and the one thing it can't do.",
    ],
    manifestations: [
  ...
  recognitionCards: [
    {
      ...
      validationCopy:
        "There's a good deal of truth in that and we're not going to argue with it. Plenty of people are treating dating as a market, and effort genuinely does go unreciprocated a lot of the time. Keep the observation — it's earned. The only thing worth checking is whether it's arriving before you've seen anything about a particular person.",
      secondaryExamples: [
    ...
    },
    {
      ...
      explanation:
        "If you bought it, you can stop being able to afford it — which is why the effort can never come down.",
      secondaryExamples: [
    ...
    },
    {
      ...
      explanation:
        "There's a partial answer, and the strongest signal is one you can only get by declining something.",
      secondaryExamples: [
    ...
    },
    {
      ...
      explanation:
        "\u201cToo much\u201d is almost always measured against a baseline of nothing — which says more about how unaccustomed everyone is than about your needs.",
      secondaryExamples: [
    ...
    },
    {
      ...
      explanation:
        "It works. It also can't distinguish — it holds off the people who'd take and the people who wouldn't at the same rate.",
      secondaryExamples: [
        "I feel used in relationships.",
        "I feel replaceable.",
      ],
  ...
  plays: [
    // ───────────────────────────────────────────── Play 1 ──
    {
      ...
      screens: [
        {
          kind: "shift",
          body: [
            "If being wanted is something you buy, the price is ongoing — and a purchase can be lost, so the effort can never come down.",
            "It also makes the evidence useless. Every sign that someone wants you gets explained by what you've been providing, so none of it can count.",
            "That's the trap. Not that you're wrong about people — that the belief makes itself impossible to test. While you're paying, you can never find out whether you needed to.",
          ],
        },
        {
          kind: "learn",
          body: [
            "The way out isn't giving less as a strategy. Giving less in order to test someone is the same arrangement running in reverse, and it produces the same unusable evidence.",
            "What produces information is one specific thing, not offered, with someone specific — and then watching what happens. Small enough that the answer is survivable either way.",
          ],
        },
        {
          kind: "ownTurn",
          intro:
            "What are you actually providing? Be concrete — this is usually more than people realise.",
          fields: [
            {
              id: "what-i-give",
            ...
            },
            {
              ...
              input: "text",
              placeholder: "Small. Survivable if it goes badly. Specific to one person.",
            },
          ],
        },
        {
          ...
          needMoreIntro:
            "Then the belief is untested. That isn't the same as it being wrong. It means the evidence you'd need has never been available to you.",
        ...
        },
        {
          ...
          body:
            "Not a decision to stop giving. A clear view of what the giving is buying and whether you've ever checked.",
        },
        {
          kind: "portable",
          ...
          steps: [
            ...
            "While I'm paying, no evidence can count.",
            "Giving less to test someone is the same arrangement in reverse.",
          ],
        },
      ],
      portable: [
      ...
      myPlaysTemplate: {
        ...
        watchOut: "Withholding as a test — that produces the same unusable evidence",
        remember: "Untested isn't the same as wrong. It means the evidence has never been available.",
      },
      fidelity: {
        correct:
    ...
    // ───────────────────────────────────────────── Play 2 ──
    {
      ...
      recognitionGate: {
        prompt: "Do you find every kind thing ambiguous, because it might be about what you provide?",
      },
      screens: [
        {
          kind: "shift",
          body: [
            "\u201cI don't know how to tell if someone wants me or just wants what I offer.\u201d It's the practical question here, and there's a partial answer.",
            "Not a certain one. But some signals lean toward the person and some lean toward the provision, and knowing which is which is better than treating everything as ambiguous.",
          ],
        },
        {
          kind: "learn",
          body: [
            "Toward the person: they ask about things unrelated to what you provide, they notice when you're depleted without being told, they offer something when nothing needs solving, they're interested in your opinions rather than your capabilities.",
            "Toward the provision: warmth that arrives when something is needed, appreciation phrased around what you did rather than who you are, interest that thins when you're unavailable.",
            "And the strongest signal of all is one you can only get by declining something — which is why this question tends to stay open indefinitely.",
          ],
        },
        {
          kind: "scenarioSort",
          ...
          situation:
            "Someone you've been seeing has been consistently lovely. You've also been doing a great deal for them.",
          buckets: [
          ...
          items: [
            {
              ...
              correction: "Appreciation of the capability. Lovely, and not about you.",
            },
            {
              id: "sort-c27-asked-about-book",
              text: "They asked what you thought about something with no bearing on them",
              correctBucket: "person",
              correction: "Interest with no practical return. That leans your way.",
            },
            {
            ...
            },
            {
              ...
              text: "Interest drops off when you've been unavailable for a week",
              correctBucket: "provision",
              correction:
                "Worth more than one instance to judge — but repeated, it leans.",
            },
            {
              id: "sort-c27-stayed-after-no",
              text: "You said no to something and they were fine and stayed",
              correctBucket: "person",
              correction: "The strongest signal there is, and the hardest to get.",
            },
          ],
        },
        {
          kind: "ownTurn",
          intro: "Now one person you're currently unsure about.",
          fields: [
            {
              id: "toward-person",
              label: "What have you seen that leans toward you?",
              input: "text",
              placeholder: "Specific instances, not impressions.",
            },
            {
              id: "toward-provision",
              label: "And what leans toward the provision?",
              input: "text",
        ...
        },
        {
          ...
          body:
            "A lean, not a verdict — and the strongest signal is one you haven't been able to collect yet.",
        },
        {
          kind: "portable",
          heading: "Take this with you",
          steps: [
            ...
            "Interest with no practical return leans toward me.",
      ...
      myPlaysTemplate: {
        when: "When every kind thing feels ambiguous",
        move: "Sort what I've seen into what leans toward me and what leans toward the provision",
        lookingFor: "Interest that returns nothing practical, and how a no is received",
        watchOut: "Sorting everything into the provision column because that's the safer read",
        remember: "A lean isn't a verdict, and the best signal needs me to decline something first.",
      },
      fidelity: {
        correct:
    ...
    // ───────────────────────────────────────────── Play 3 ──
    {
      ...
      screens: [
        {
          ...
          body: [
            ...
            "That third one is the giveaway. Someone doing all the managing usually has needs that arrive as an inconvenience, because there's no established channel for them.",
          ],
        },
        {
          kind: "learn",
          body: [
            "It's self-reinforcing. You manage their feelings, so yours never come up. Yours never coming up means everyone gets used to them not being there. So when one arrives it's disruptive — which confirms it was too much, and you go back to managing.",
            "\u201cToo much\u201d is almost always measured against a baseline of nothing. It isn't a measure of your needs. It's a measure of how unaccustomed everyone is to hearing them.",
          ],
        },
        {
          kind: "emotionBeat",
        ...
        },
        {
          kind: "ruleBuilder",
          intro:
            "One channel, with one person. Not a change of policy — one instance.",
          conditionLabel: "The one need I'll say out loud, to one person",
          thenLabel: "And if it lands badly, I'll",
          actions: [
            "Note it and not conclude anything from one instance",
            "Say it again to someone else",
            "Ask them directly what happened",
            "Leave it there for now",
          ],
          controlCheck:
            "\u201cToo much\u201d is measured against a baseline of nothing \u2014 so a bad first reaction is about the unfamiliarity, not about the size of what I asked.",
        },
        {
          kind: "output",
        ...
        },
        {
          ...
          heading: "Take this with you",
          steps: [
            "My needs arrive as a disruption because they never arrive at all.",
      ...
      myPlaysTemplate: {
        ...
        watchOut: "Concluding from a single reaction that the need was too big",
        remember: "The disruption is about unfamiliarity, not about the size of what I asked.",
      },
      fidelity: {
        correct:
    ...
    // ───────────────────────────────────────────── Play 4 ──
    {
      ...
      screens: [
        {
          kind: "shift",
          body: [
            "It works. That's the first thing to say — the guard does reduce how often you get used, and it was built for a reason.",
            "Nothing here asks you to lower it. That would be asking you to be more available to the thing that hurt you.",
          ],
        },
        {
          kind: "learn",
          body: [
            "What it can't do is distinguish. Armor is undirected — it holds off the people who'd take and the people who wouldn't, at the same rate.",
            "And it makes the evidence unavailable. You can't find out whether someone would have wanted you for yourself while they're being held at the distance where they can't show you.",
            "So it buys protection and it costs information. That's a real trade, and it might be the right one for now. It's worth knowing it's a trade rather than a free arrangement.",
          ],
        },
        {
          kind: "ownTurn",
          ...
          fields: [
            ...
            },
            {
              ...
              input: "text",
              placeholder: "Be specific if you can. Opportunities, people, time.",
            },
            {
              id: "aim-it",
              label:
                "Is there one person where you could aim it rather than wear it — one specific thing you'd check rather than holding everything back?",
              input: "text",
        ...
        {
          kind: "sufficiency",
          prompt: "Is the guard currently the thing making this survivable?",
          enoughLabel: "Yes — I need it where it is",
          needMoreLabel: "Not entirely — it's costing more than it's saving",
          needMoreIntro:
            "Either is a legitimate answer. There's no version of this that requires you to be less protected than you can manage.",
        ...
        },
        {
          ...
          heading: "Take this with you",
          steps: [
            "Armor is undirected. It holds off everyone at the same rate.",
      ...
      myPlaysTemplate: {
        ...
        move: "Name what the guard costs, and whether it could be aimed rather than worn",
        lookingFor: "Whether it's currently the thing making this survivable",
  ...
  missions: [
    {
      ...
      instruction:
        "The small thing you named — don't offer it, once. Then note what actually happened, rather than what you expected.",
      ...
      suitability:
        "If not offering it would genuinely harm someone, pick something else. This isn't a test worth running at anyone's expense.",
      progression: [
        {
    ...
    },
    {
      ...
      progression: [
        {
          id: "rung-c27-lean-2",
          instruction: "Decline one small thing and watch how it's received.",
        },
      ],
    },
    {
      ...
      attemptMeaning:
        "You said it twice. Two data points beat one, especially if the first went badly.",
      suitability:
    ...
    },
    {
      ...
      title: "Aim it once",
      instruction:
        "With one person, replace the general guard with one specific thing you're checking. Note whether anything reads differently.",
      linkToOperation: "Converting undirected protection into a specific check",
      attemptMeaning:
        "You aimed it. Keeping the guard where it is remains a legitimate outcome.",
      suitability:
        "If the guard is currently what makes dating survivable, don't do this one. That's not a failure — it's an accurate read of where you are.",
      progression: [
        {
          id: "rung-c27-armor-2",
  ...
  useReviews: [
    ...
    },
    {
      ...
      performedOperation: {
        label: "Did you sort by whether it returns something practical?",
        options: ["Yes", "Partly", "No"],
      },
      becameClearer: {
        label: "What got clearer?",
        ...
        options: [
          ...
          "That I can't tell without declining something",
          "Nothing new",
        ],
      },
      stuckWhere: {
        label: "Where did you get stuck?",
        options: [
          "Everything felt like it was about the provision",
    ...
    },
    {
      ...
      performedOperation: {
        label: "Did you name the cost and consider aiming rather than lowering?",
        options: ["Yes", "Partly", "No"],
      },
      becameClearer: {
        label: "What got clearer?",
