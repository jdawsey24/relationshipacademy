...
const REGISTRY: Record<string, PlaybookContent> = {
  ...
  // Clusters 3–10, 14, 15, 18 & 24 — content scaffolded (Plays-only), registered for
  // preview/validation. NOT yet in INTERACTIVE_PLAYBOOK_KEYS or PLAYBOOK_KEY_TO_CLUSTER
  // (lib/playbook/keys.ts): the app will not serve them until publish-wiring lands + gates clear.
