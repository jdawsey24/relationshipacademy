...
export default function PhaseCard({ number, name, task, description, color, href }: PhaseCardProps) {
  ...
  return (
    ...
    >
      ...
      <span className="mt-2 font-ui text-[12px] uppercase tracking-wide text-charcoal/50">
