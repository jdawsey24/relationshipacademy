    ...
    progression: [
      {
        id: "decide",
        instruction:
          "Ready to stretch it? Next time, don't just read it — decide. Run your “if I see ___, I'll ___,” and make one clear move from the evidence.",
      },
    ],
  },
  {
    ...
    progression: [
      {
        ...
        instruction:
          "Ready to stretch it? Next time, notice you can name the narrowest true thing even while the bigger story still feels true. The feeling can stay — it just isn't the evidence.",
      },
    ],
  },
];
