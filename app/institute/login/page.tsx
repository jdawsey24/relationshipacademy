    ...
    <div className="flex min-h-screen items-center justify-center px-6 py-16">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-2 font-display text-3xl font-semibold text-midnight-navy">Professional login</h1>
        </div>
        <form onSubmit={handleSubmit} className="rounded-2xl border border-midnight-navy/10 bg-white p-8 shadow-sm">
          ...
          <div className="mt-4 flex items-center justify-between font-ui text-sm">
            <Link href="/institute/reset-password" className="text-midnight-navy/70 hover:text-midnight-navy">Forgot password?</Link>
            <Link href="/institute/signup" className="text-midnight-navy/70 hover:text-midnight-navy">Create account</Link>
          </div>
        </form>
      </div>
    </div>
